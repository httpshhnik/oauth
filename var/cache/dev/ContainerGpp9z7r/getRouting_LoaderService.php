...
$b->addLoader(new \FOS\RestBundle\Routing\Loader\RestYamlCollectionLoader($c, $d, false, array('json' => false, 'xml' => false, 'html' => true), 'json'));
$b->addLoader(new \FOS\RestBundle\Routing\Loader\RestXmlCollectionLoader($c, $d, false, array('json' => false, 'xml' => false, 'html' => true), 'json'));
$b->addLoader($f);
